...
<body style="background-color: #2bff1e;">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="false" style="padding-top: 15px;">
	<div class="carousel-inner">
	    <div class="carousel-item active" style="background-image: url('./gambar/latarMateri/materiC1.png');">
		  <div class="row">
			<div class="col-md-3">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiC2.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiC3.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiC4.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiC5.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiC6.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
...
function simpanPoin() 
{
		location.href= 'materiTiga/cekPoin' + '/' + poin;
}
