...
<body style="background-color: #2bff1e;">
  ...
  <div class="text-center" style="position: absolute; z-index: -1;">
    <img src="gambar/latarMateri/materiSatuu.png" class="img-fluid" alt="Responsive image" >
  </div>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="false" style="padding-top: 15px;">
	<div class="carousel-inner">
	    <div class="carousel-item active" style="background-image: url('./gambar/latarMateri/materiA11.png');">
		  <div class="row">
			<div class="col-md-3">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiA2.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiA3.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiA4.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiA55.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiA6.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
...
function simpanPoin() 
{
		location.href= 'materiSatu/cekPoin' + '/' + poin;
}
