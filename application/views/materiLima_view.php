...
<body style="background-color: #2bff1e;">
  ...
  <div class="text-center" style="position: absolute; z-index: -1;">
    <img src="gambar/latarMateri/materiLima.png" class="img-fluid" alt="Responsive image" >
  </div>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="false" style="padding-top: 15px;">
	<div class="carousel-inner">
	    <div class="carousel-item active" style="background-image: url('./gambar/latarMateri/materiE1.png');">
		  <div class="row">
			<div class="col-md-3">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiE2.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiE3.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiE4.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiE5.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
	    ...
	    <div class="carousel-item" style="background-image: url('./gambar/latarMateri/materiE6.png');">
		  <div class="row">
			<div class="col-md-3 text-left">
				<div class="col-md-12 kotakPilihanHuruf">
					<div class="row card-body">
...
function simpanPoin() 
{
		location.href= 'materiLima/cekPoin' + '/' + poin;
}
